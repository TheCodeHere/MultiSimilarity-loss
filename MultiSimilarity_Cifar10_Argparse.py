...
# Model (on Device)
Network_model = to_device(ResNet_size(size=18, in_channels=3, output_size=output_dim, base=base), device)
...
File_name = "Log/MultiSim/Cifar10/" + str(output_dim) + "d/Cifar_acc-" + str(acc) + "_bs-" + str(batch_size) + "_eps-" + str(epochs) + "_lr-" + str(max_lr) + "_b-" + str(base) + ".pth"
