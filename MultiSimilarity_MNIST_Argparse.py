...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channels=1, output_size=2, alpha=2, beta=40, base=1.0):
...
def ResNet_size(size=10, in_channels=1, output_size=2, alpha=2, beta=40, base=1.0):
    if size == 10:
...
File_name = "Log/MultiSim/MNIST/" + str(output_dim) + "d/MNIST_acc-" + str(acc) + "_bs-" + str(batch_size) + "_eps-" + str(epochs) + "_lr-" + str(max_lr) + "_a-" + str(alpha) + "_bt" + str(beta) + "_b-" + str(base) + ".pth"
